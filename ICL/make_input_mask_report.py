...
RUN_MODELS = OrderedDict(
    [
        ...
        (
            ...
            [
                ("num", "d_rel"),
                ("num", "comparison_branch_common_d_rel_min"),
                ("num", "comparison_branch_common_d_rel_gini"),
        ...
        (
            ...
            [
                ...
                ("num", "target_logprob_margin_branch_mean_min"),
                ("num", "branch_active_tree_mi"),
                ("num", "branch_active_tree_nmi"),
    ...
    [
        ...
        (
            ...
            [
                ...
                ("num", "target_logprob_margin_branch_mean_min_mean"),
                ("num", "branch_active_tree_mi_mean"),
                ("num", "branch_active_tree_nmi_mean"),
...
def summarize_extracted_essential_masks(selected_rows, library_rows):
    ...
    return {
        ...
        "comparison_branch_common_d_rel_min_mean": mean(
            numeric_values(selected_rows, "comparison_branch_common_d_rel_min")
        ),
        ...
        rows.append(
            {
                ...
                "comparison_branch_common_d_rel_min_mean": mean(
                    numeric_values(group, "comparison_branch_common_d_rel_min")
                ),
                "comparison_branch_d_rel_min_mean": mean(
                ...
                "target_logprob_margin_branch_mean_min_mean": mean(
                    numeric_values(group, "target_logprob_margin_branch_mean_min_mean")
                ),
                "branch_active_tree_mi_mean": mean(numeric_values(group, "branch_active_tree_mi_mean")),
                "branch_active_tree_nmi_mean": mean(numeric_values(group, "branch_active_tree_nmi_mean")),
        ...
        lines.append(
            ...
            + " | ".join(
                [
                    ...
                    fmt(row.get("comparison_branch_common_d_rel_min_mean"), 0),
                    fmt(row["target_logprob_margin_branch_mean_min_mean"]),
        ...
        lines.append(
            ...
            + " | ".join(
                [
                    ...
                    fmt(row.get("d_rel"), 0),
                    fmt(row.get("comparison_branch_common_d_rel_min"), 0),
                    fmt(row.get("target_logprob_margin_branch_mean_min_mean")),
                    fmt(row.get("effective_rank_D_masked")),
                    fmt(row.get("input_edge_load_gini")),
                    fmt(row.get("branch_active_tree_mi_mean")),
                    fmt(row.get("branch_active_tree_nmi_mean")),
        ...
        lines.append(
            ...
            + " | ".join(
                [
                    ...
                    fmt(summary.get("comparison_branch_common_d_rel_min_mean"), 1),
                    source_icl,
                ]
            )
            + " |"
            ...
            lines.append(
                ...
                + " | ".join(
                    [
                        ...
                        fmt(mask.get("comparison_branch_common_d_rel_min"), 0),
