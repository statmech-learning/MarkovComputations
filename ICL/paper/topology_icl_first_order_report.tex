...
\[
\boxed{\;\drel(G,\Omega)=\sum_{\alpha=1}^{p}\operatorname{rank}\ig(D_G\operatorname{diag}(\Omega_{\cdot\alpha})\big).\;}
\]
...
\texttt{stat\_preserving\_causal\_stratified/summary.json} & stratified causal scrambles\\
...
\[
R^2_{\rm LOO}=0.740\quad \text{at run level},
\qquad
R^2_{\rm LOO}=0.809\quad \text{at topology-mean level},
\qquad
R^2_{\rm LOO}=0.599\quad \text{for topology-best seed}.
\]
