...
Generated: 2026-05-07. The hard-pilot evidence was added in commit `22de6ec` (`Add hard topology pilot evidence`). The branch now also includes the follow-up orchestration commits through `fe4caf9`, which add explicit submitted-job Python control, causal finalizer orchestration, and hard-pilot follow-up documentation.
...
- Local unit tests: `python3 -m unittest discover -s ICL/tests`, `118` tests passed.
